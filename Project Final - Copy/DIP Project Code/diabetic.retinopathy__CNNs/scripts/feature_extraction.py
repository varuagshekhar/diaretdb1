...
parser.add_argument('--img', type=str, required=False, default="image001.png",
                    help='C://VIT//Semester 5//ITE1010//Project//diabetic.retinopathy__deep.learning-master//diabetic.retinopathy__deep.learning-master//normalised_images')
